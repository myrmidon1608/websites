			<div class="content" id="aboutContent">
                <div id="t4">
                	<ul class="about-nav">
                    	<li onclick="tabChange(event, 'about');">About Me <span>&nbsp;&#58;&nbsp;&nbsp;</span></li>
                        <li onclick="tabChange(event, 'about');">Resume</li>
                	</ul>
                    <div>
                    	<div>
                        <img src="images/myrmidon.gif" style="margin-top:20px;" align="right" alt="" />
                        <h2>About Me</h2>
                        ...
                        <img src="images/self2.png" style="margin:5px 15px 5px 0px;" align="left" alt="" />
                        ...
                        <p>The main use for this webpage is to advance my brand and creative work. All of my additions to this web space, whether they are new or updates to existing works, are strictly for my portfolio uses only. This website, as is outlined in my <a href="professional-writing/website-proposal.docx">Website Proposal</a>, is a place where visiting potential employers, as well as anyone else who might be interested in my past experiences, projects, and resume, can observe the content. Please do not lurk or spam my website or email address. However, all of the information on the webpage is free to explore for those interested.</p>
                        ...
                        <p class="intro">&copy; 2012</p>
                        </div>                  	
                    	<div style="display:none;"><?php include ('about-me/resume.php'); ?></div>
                    </div>
                </div>
            </div>
