/*
FREESTYLE MENUS v1.0 RC (c) 2001-2006 Angus Turnbull, http://www.twinhelix.com/dhtml/fsmenu/
...
function FSMenuNode(id, isRoot, obj)
{
 ...
 if (this.id != 'root') with (this) with (lyr = getLyr(id)) if (ref)
 {
  ...
  addEvent(ref, 'mouseover', this.over); //change the mouseover to onclick
