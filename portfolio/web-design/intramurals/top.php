<!DOCTYPE html>
<head>
<title>TCNJ Intramural Sports &amp; REC Center <?php echo $title ?></title>
			...
			<ul class="drop">
				...
				<li class="sports"><a href="intramurals.php" class="main-list" onmouseover="mopen('m1')" onmouseout="mclosetime()">INTRAMURAL SPORTS</a>
					<div id="m1" class="drop-int" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
                        <a href="intramurals/basketball.php">Example 1</a>
                        <a href="intramurals/volleyball.php">Example 2</a>
                        <a href="intramurals/intramural-handbook.php">Handbook</a>
					</div>
				</li>
